...
class KioskMen extends Component
{
    public $modalOpen;
    ...
    {
        $products = Stock::where('product_category', 'Men')->paginate(6);
        return view('livewire.kiosk-men', compact('products'));
    }
}
