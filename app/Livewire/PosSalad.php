...
class PosSalad extends Component
{
    public $modalOpen;
    ...
    {
        $products = Stock::where('product_category', 'Salad')->paginate(6);
        return view('livewire.pos-salad', compact('products'))->layout($this->layout);
    }
}
