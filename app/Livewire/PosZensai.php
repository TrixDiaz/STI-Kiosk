...
class PosZensai extends Component
{
    public $modalOpen;
    ...
    {
        $products = Stock::where('product_category', 'Zensai')->paginate(6);
        return view('livewire.pos-zensai', compact('products'))->layout($this->layout);
    }
}
