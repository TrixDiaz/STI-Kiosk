...
class PosDonmono extends Component
{
    public $modalOpen;
    ...
    {
        $products = Stock::where('product_category', 'Donmono')->paginate(6);
        return view('livewire.pos-donmono', compact('products'))->layout($this->layout);
    }
}
