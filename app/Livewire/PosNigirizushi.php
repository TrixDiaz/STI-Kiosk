...
class PosNigirizushi extends Component
{
    public $modalOpen;
    ...
    {
        $products = Stock::where('product_category', 'Nigirizushi')->paginate(6);
        return view('livewire.pos-nigirizushi', compact('products'))->layout($this->layout);
    }
}
