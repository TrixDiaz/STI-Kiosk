...
class PosYakizakana extends Component
{
    public $modalOpen;
    ...
    {
        $products = Stock::where('product_category', 'Yakizakana')->paginate(6);
        return view('livewire.pos-yakizakana', compact('products'))->layout($this->layout);
    }
}
