...
class PosRamen extends Component
{
    public $modalOpen;
    ...
    {
        $products = Stock::where('product_category', 'Ramen')->paginate(6);
        return view('livewire.pos-ramen', compact('products'))->layout($this->layout);
    }
}
