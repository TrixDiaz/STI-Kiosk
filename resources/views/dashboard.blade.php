                                                        ...
                                                        <div class="grid grid-cols-3 gap-2">
                                                            @for ($i = 1; $i <= 9; $i++)
                                                                <button type="button"
                                                                        ...
                                                                        class="bg-gray-200 hover:bg-gray-300 text-gray-700 text-2xl p-4 font-semibold py-2 px-4 rounded">
                                                                    {{ $i }}
                                                                </button>
                                                            @endfor
                                                            ...
                                                            <button type="button"
                                                                    ...
                                                                    class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold text-2xl p-4 py-2 px-4 rounded">
                                                                0
                                                            </button>

                                                            <button type="button"
                                                                    onclick="clearAmount('{{ $order['order_id'] }}')"
                                                                    class="bg-red-200 hover:bg-red-300 text-red-700 font-semibold text-2xl p-4 py-2 px-4 rounded">
                                                                Clear
                                                            </button>
                                                        </div>
                                                        <!-- Footer -->
